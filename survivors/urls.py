...
urlpatterns = [
    ...
    path("detention-event/<int:pk>/edit/",
         views.detention_event_edit, name="detention_event_edit"),
    path("detention-event/<int:pk>/delete/",
         views.detention_event_delete, name="detention_event_delete"),
    ...
    path("<int:pk>/export-single/",
         exports.export_single_survivor_json, name="export_single"),
